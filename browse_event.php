    ...
    <nav class="navbar-wrapper navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand"  href="main_dashbord.php?user<?php echo $username;?>"><span class="glyphicon glyphicon-home"></span> Event Compass</a>
          </div>
        ...
        <ul class="nav nav-pills nav-stacked text-center">
          ...
          <li><a href="music.php">Music</a></li>
           <li><a href="visualarts.php">Visual Arts</a></li>
            <li><a href="sciandtech.php">Science & Technology</a></li>
             <li><a href="sports.php">Sports & Fitness</a></li>
        </ul>
      </div>
  </div>   
